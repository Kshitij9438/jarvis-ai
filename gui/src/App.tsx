...
function getEventState(event: JarvisEvent): "success" | "neutral" {
  if (
    ...
    <div className="jarvis-shell">
      ...
      <header className="topbar">
        ...
        <div className="topbar-actions">
          ...
          <button
            className={`topbar-button inspector-button ${
              developerOpen ? "active" : ""
            }`}
            onClick={() =>
      ...
      <main className="main">
        ...
        {hasConversation && !loading && events.length > 0 && (
          <button
          ...
          >
            ...
            <span className="execution-arrow">→</span>
          </button>
        )}
      </main>
